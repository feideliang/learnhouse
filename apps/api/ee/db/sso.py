...
SSOProviderType = Literal["workos", "keycloak", "okta", "auth0", "custom_saml", "custom_oidc", "sourceid"]
...
class SourceIDConfig(BaseModel):
    """SourceID (锐捷) OAuth 2.0 provider configuration."""
    base_url: str
    client_id: str
    client_secret: str

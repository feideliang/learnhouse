...
from src.services.ai.base import get_chat_session_history, LH_CONFIG
...
async def editor_ai_start_chat_session_stream(
    ...
    # Resolve AI model from config
    ai_model = getattr(LH_CONFIG.ai_config, 'ai_model_name', None) or "gpt-4o-mini"

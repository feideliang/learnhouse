...
def get_storage_client():
    ...
    with _s3_client_lock:
        ...
        if learnhouse_config.hosting_config.content_delivery.s3api.secret_key:
            kwargs["aws_secret_access_key"] = learnhouse_config.hosting_config.content_delivery.s3api.secret_key
